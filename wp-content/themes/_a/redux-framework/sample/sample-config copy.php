 ...
 // -> START General Settings
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'opt-desc-checkbox',
                'type'     => 'checkbox',
                'title'    => __( 'Display site tagline under logo?', 'redux-framework-demo' ),
                'subtitle' => __( 'Tagline can be changed in General - Settings', 'redux-framework-demo' ),
            ...
            array(
                ...
                //'desc'     => __( 'Upload a favicon image ( 16x16px ) ', 'redux-framework-demo' ),
                'subtitle' => __( 'Upload a favicon image (16x16px)', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'opt-tracking-code',
                'type'     => 'textarea',
                'title'    => __( 'Tracking Code', 'redux-framework-demo' ),
                'subtitle' => __( 'Paste your google analytics code or other tracking code here', 'redux-framework-demo' ),
